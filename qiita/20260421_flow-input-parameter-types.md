...
<img src="../images/verification/20260402_flow-input-types/フロートリガー画面のスクリーンショット.png" alt="フロートリガー画面" width="60%">
...
<img src="../images/verification/20260402_flow-input-types/フロートリガーを日付型で設定.png" alt="フロートリガーを日付型で設定" width="60%">

Copilot Studio 側からこのフローを呼び出そうとすると、エラーになります。これは、フロー側で日付型として定義したパラメーターが、Copilot Studio 側では String 型として認識されてしまい、型が一致しないためです。

<img src="../images/verification/20260402_flow-input-types/フロートリガーを日付で使用した場合のエラー画面.png" alt="フロートリガーを日付型で使用した場合のエラー画面" width="60%">
...
<img src="../images/verification/20260402_flow-input-types/Copilot%20Studio%20の日付確認.png" alt="Copilot Studio の質問ノードで日付を確認" width="30%">
...
<img src="../images/verification/20260402_flow-input-types/Copilot%20Studio%20のアクションノード画面.png" alt="Copilot Studio のアクションノード画面" width="30%">
...
<img src="../images/verification/20260402_flow-input-types/フロー側の%20formatDateTime%20変換画面.png" alt="フロー側の formatDateTime 変換画面" width="50%">
